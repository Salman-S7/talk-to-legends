        ...
        <section className="relative min-h-screen flex items-center justify-center px-4 sm:px-6 lg:px-8 z-10">
          ...
          <div className="fixed bottom-8 right-8 z-[999999]">
            <a
              ...
              className="block w-24 h-24 bg-white dark:bg-neutral-800 rounded-full shadow-lg border border-neutral-200 dark:border-neutral-700 hover:shadow-xl transition-all duration-300 hover:scale-110 group"
            ...
            >
              <img
                ...
                alt="Bolt.new"
                className="w-full h-full object-contain animate-[spin_8s_linear_infinite] group-hover:animate-[spin_1s_linear_infinite]"
              />
            </a>
          </div>
        </section>
